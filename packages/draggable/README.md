...
A complete example can be found the [playground](https://github.com/khulnasoft/scalar/tree/main/packages/draggable/playground), but basically you need a data structure like:
...
You can find an example in this repo under the [playground](https://github.com/khulnasoft/scalar/tree/main/packages/draggable/playground)
