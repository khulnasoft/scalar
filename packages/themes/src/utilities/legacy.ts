...
export function migrateThemeVariables(styles: string): string {
  ...
  console.warn(
    `DEPRECATION WARNING: It looks like you're using legacy CSS variables in your custom CSS string. Please migrate them to use the updated prefixes. See https://github.com/khulnasoft/scalar#theme-prefix-changes`,
  )
