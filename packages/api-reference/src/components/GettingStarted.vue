  ...
  <div class="start custom-scroll">
    ...
    <div class="start-row">
      <div class="start-section start-section-integrations">
        ...
        <a
          class="start-item"
          href="https://github.com/khulnasoft/scalar/tree/main/packages/fastify-api-reference#readme"
          target="_blank">
          <svg
            fill="currentColor"
            height="16"
        ...
        <a
          class="start-item"
          href="https://github.com/khulnasoft/scalar/tree/main#from-a-cdn"
          target="_blank">
          <svg
            fill="currentColor"
            viewBox="0 0 24 24"
        ...
        <a
          class="start-item"
          href="https://github.com/khulnasoft/scalar/tree/main#with-vuejs"
          target="_blank">
          <svg
            height="170"
        ...
        <a
          class="start-item"
          href="https://github.com/khulnasoft/scalar/tree/main#with-react"
          target="_blank">
          <svg
            height="23.3"
            viewBox="0 0 22 23.3"
